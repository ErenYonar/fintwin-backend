...
const PRESET_DATA: Record<string, { TR: PresetItem[]; EN: PresetItem[] }> = {
  ...
  'Abonelik': {
    TR: [
      { label: 'Netflix (Temel)',                    price: 189.99 },
      { label: 'Netflix (Standart)',                 price: 289.99 },
      { label: 'Netflix (Premium)',                  price: 379.99 },
      { label: 'YouTube Premium (Bireysel)',         price: 79.99 },
      { label: 'YouTube Premium (Aile)',             price: 159.99 },
      { label: 'YouTube Premium (Öğrenci)',          price: 52.99 },
      { label: 'YouTube Premium Lite',               price: 49.99 },
      { label: 'ChatGPT (Free)',                     price: 0.00 },
      { label: 'ChatGPT Plus',                      price: 769.00 },
      { label: 'Claude (Free)',                      price: 0.00 },
      { label: 'Claude Pro',                         price: 769.00 },
      { label: 'Gemini (Free)',                      price: 0.00 },
      { label: 'Gemini Advanced',                    price: 769.00 },
      { label: 'Spotify Premium (Bireysel)',         price: 99.00 },
      { label: 'Spotify Premium (Öğrenci)',          price: 55.00 },
      { label: 'Spotify Premium Duo',                price: 135.00 },
      { label: 'Spotify Premium (Aile)',             price: 169.00 },
      { label: 'Disney+ (Standart)',                 price: 249.90 },
      { label: 'Disney+ (Premium)',                  price: 449.90 },
    ...
    EN: [
      { label: 'Netflix (Basic)',                    price: 189.99 },
      { label: 'Netflix (Standard)',                 price: 289.99 },
      { label: 'Netflix (Premium)',                  price: 379.99 },
      { label: 'YouTube Premium (Individual)',       price: 79.99 },
      { label: 'YouTube Premium (Family)',           price: 159.99 },
      { label: 'YouTube Premium (Student)',          price: 52.99 },
      { label: 'YouTube Premium Lite',               price: 49.99 },
      { label: 'ChatGPT (Free)',                     price: 0.00 },
      { label: 'ChatGPT Plus',                      price: 769.00 },
      { label: 'Claude (Free)',                      price: 0.00 },
      ...
      { label: 'Gemini (Free)',                      price: 0.00 },
      { label: 'Gemini Advanced',                    price: 769.00 },
      { label: 'Spotify Premium (Individual)',       price: 99.00 },
      { label: 'Spotify Premium (Student)',          price: 55.00 },
      { label: 'Spotify Premium Duo',                price: 135.00 },
      { label: 'Spotify Premium (Family)',           price: 169.00 },
      { label: 'Disney+ (Standard)',                 price: 249.90 },
      { label: 'Disney+ (Premium)',                  price: 449.90 },
      { label: 'Amazon Prime',                 price: 39.00 },
